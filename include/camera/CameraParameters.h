...
public:
    ...
    static const char EFFECT_ANTIQUE[]; // Samsung
    static const char EFFECT_POINT_BLUE[]; // Samsung
    static const char EFFECT_POINT_RED[]; // Samsung
    static const char EFFECT_POINT_YELLOW[]; // Samsung
    static const char EFFECT_WARM[]; // Samsung
    static const char EFFECT_COLD[]; // Samsung
    static const char EFFECT_WASHED[]; // Samsung
    ...
    static const char FLASH_MODE_FILLIN[]; // Samsung
    static const char FLASH_MODE_SLOW_SYNC[]; // Samsung
    static const char FLASH_MODE_RED_EYE_FIX[]; // Samsung
    static const char FLASH_VALUE_OF_ISP[]; // Samsung
    static const char FLASH_STANDBY_ON[]; // Samsung
    static const char FLASH_STANDBY_OFF[]; // Samsung
    ...
    static const char SCENE_MODE_BEACH_SNOW[]; // Samsung
    static const char SCENE_MODE_DUSK_DAWN[]; // Samsung
    static const char SCENE_MODE_FALL_COLOR[]; // Samsung
    static const char SCENE_MODE_BACK_LIGHT[]; // Samsung
    ...
    static const char FOCUS_MODE_MULTI[]; // Samsung
    static const char FOCUS_MODE_TOUCH[]; // Samsung
    static const char FOCUS_MODE_OBJECT_TRACKING[]; // Samsung
    static const char FOCUS_MODE_FACE_DETECTION[]; // Samsung
    static const char FOCUS_MODE_SMART_SELF[]; // Samsung
    static const char FOCUS_MODE_MANUAL[]; // Samsung
    static const char FOCUS_MODE_FIXED_FACE[]; // Samsung
    ...
    // HSR Dummy fix for Highspeed recording
    static const char KEY_VIDEO_HSR[];
